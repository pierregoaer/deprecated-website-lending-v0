            ...
            <div className="section-inner footer-main">
                <div className="footer-nav">
                    ...
                    <div className="column flex-column">
                        ...
                        <Link to={'/installation-electrique'}>Installation électrique</Link>
                        <Link to={'/renovation-electrique'}>Rénovation électrique</Link>
                        <Link to={'/depannage-electrique'}>Dépannage électrique</Link>
