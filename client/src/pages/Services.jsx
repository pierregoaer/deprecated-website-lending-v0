    ...
    return (
        <>
            ...
            <section className="silo-container">
                <div className="section-inner silo-main">
                    <div className="silo-text">
                        ...
                        <p>Notre entreprise d'électricité à Nîmes vous propose une gamme complète de services
                            ...
                            rénovations, de dépannages, d'éclairage ou de domotique et objets connectés. Notre équipe
                            d'électriciens professionnels est à votre écoute pour vous accompagner et vous conseiller
                    ...
                    <div className="silo-cards">
                        <div className="silo-card">
                            <div className="silo-card-text">
                                ...
                                <p>Que vous ayez besoin d'une installation électrique pour un bâtiment neuf ou pour
                                    remplacer un système existant, nous sommes là pour vous aider. Nous réalisons des
                                    installations électriques résidentielles, commerciales et industrielles, en veillant
                                    à respecter les normes en vigueur et à optimiser la sécurité et la performance de
                                    vos équipements.</p>
                        ...
                        <div className="silo-card">
                            <div className="silo-card-text">
                                ...
                                <p>La rénovation électrique est essentielle pour garantir la sécurité et la conformité
                                    de vos installations. Nous prenons en charge la mise aux normes, le remplacement de
                                    tableaux électriques et la réparation de circuits électriques. Nos électriciens à
                                    Nîmes travaillent avec rigueur et professionnalisme pour assurer la qualité et la
                        ...
                        <div className="silo-card">
                            <div className="silo-card-text">
                                ...
                                <p>En cas de panne ou d'urgence électrique, notre équipe de dépannage intervient
                                    rapidement pour résoudre vos problèmes. Nous diagnostiquons et réparons les pannes,
                                    et remplaçons les composants défectueux. Nos électriciens sont disponibles 24/7 pour
                        ...
                        <div className="silo-card">
                            <div className="silo-card-text">
                                ...
                                <p>Nous proposons des solutions d'éclairage intérieur et extérieur adaptées à vos
                                    besoins et à votre budget. Notre équipe vous conseille sur les meilleures options
                                    pour économiser de l'énergie et améliorer le confort de votre habitat ou de votre
                        ...
                        <div className="silo-card">
                            <div className="silo-card-text">
                                ...
                                <p>La domotique et les objets connectés révolutionnent notre façon de vivre et de gérer
                                    notre quotidien. Nous vous accompagnons dans l'installation de systèmes domotiques
                    ...
                    <div className="silo-text">
                        <p>Faites appel à notre entreprise d'électricité à Nîmes pour bénéficier d'une gamme complète de
                            services électriques adaptés à vos besoins. Notre équipe de professionnels qualifiés est à
                            votre service pour vous offrir des solutions sur-mesure et vous garantir des installations
